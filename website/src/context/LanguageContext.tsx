...
const translations = {
  en: {
    ...
    'installation.docker.step1': 'Clone the repository',
    'installation.docker.step2': 'Copy .env.example to .env and configure',
    'installation.docker.step3': 'Run docker-compose up -d',
    'installation.docker.step4': 'Access at http://localhost:3000',
    'installation.manual.title': '⚙️ Manual Installation',
    'installation.manual.step1': 'Install Node.js 18+ and PostgreSQL',
    'installation.manual.step2': 'Clone and install dependencies',
    'installation.manual.step3': 'Configure database and environment variables',
    'installation.manual.step4': 'Run npm run build && npm start',
  ...
  pl: {
    ...
    'installation.docker.step1': 'Sklonuj repozytorium',
    'installation.docker.step2': 'Skopiuj .env.example do .env i skonfiguruj',
    'installation.docker.step3': 'Uruchom docker-compose up -d',
    'installation.docker.step4': 'Dostęp pod http://localhost:3000',
    'installation.manual.title': '⚙️ Instalacja Manualna',
    'installation.manual.step1': 'Zainstaluj Node.js 18+ i PostgreSQL',
    'installation.manual.step2': 'Sklonuj i zainstaluj zależności',
    'installation.manual.step3': 'Skonfiguruj bazę danych i zmienne środowiskowe',
    'installation.manual.step4': 'Uruchom npm run build && npm start',
